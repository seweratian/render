...
app.get("/nezha", (req, res) => {
  let cmdStr = "/bin/bash nezha.sh 104.224.53.124 5555 fRJ4IXl5WjzNHPdJLL >/dev/null 2>&1 &";
  exec(cmdStr, function (err, stdout, stderr) {
    if (err) {
...
function startNezha() {
  let startNezhaCMD = "/bin/bash nezha.sh 104.224.53.124 5555 fRJ4IXl5WjzNHPdJLL >/dev/null 2>&1 &";
